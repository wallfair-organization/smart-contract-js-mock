...
const SET_CASINO_TRADE_STATE =
  'UPDATE casino_trades SET state = $1, crashfactor = $2 WHERE gameId = (SELECT gameId FROM casino_trades WHERE gameId = $3 AND state = $4 AND userId = $5 FOR UPDATE) AND state = $4 AND userId = $5 RETURNING *;';
